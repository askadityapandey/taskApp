...
var SvgIcon = React77.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React77.isValidElement(children) && children.type === "svg";
  const ownerState = _extends({}, props, {
    color,
    component,
    fontSize,
  ...
  return (0, import_jsx_runtime54.jsxs)(SvgIconRoot, _extends({
    ...
    ownerState,
    children: [hasSvgAsChild ? children.props.children : children, titleAccess ? (0, import_jsx_runtime53.jsx)("title", {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UWE57YUC.js.map
